                    ...
                    <tbody>
                        @forelse($subscriptions as $subscription)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('song.show', [$subscription->song->artist->slug, $subscription->song->slug]) }}"
                                ...
                                <td>
                                    <span
                                        ...
                                        {{ $subscription->song->artist->name_english }}
                                    </span>
                                </td>
                                <td>
