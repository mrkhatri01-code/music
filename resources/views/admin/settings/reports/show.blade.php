                ...
                <div style="padding: 1.5rem; display: flex; gap: 1.5rem; align-items: flex-start;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <div style="margin-bottom: 1rem; color: #667eea;">
                            <i class="fa-solid fa-microphone"></i> {{ $report->song->artist->name_english }}
                        </div>
                        
                        <div style="display: flex; gap: 0.5rem;">
                            <a href="{{ route('song.show', [$report->song->artist->slug, $report->song->slug]) }}" target="_blank" class="btn btn-primary" style="font-size: 0.8rem; padding: 0.4rem 0.8rem;">
