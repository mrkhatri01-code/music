    ...
    <div class="row" style="display: flex; gap: 2rem; flex-wrap: wrap;">
        ...
        <div class="col-md-4" style="flex: 1; min-width: 300px; max-width: 400px;">
            <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); text-align: center;">
                ...
                @else
                    <div style="width: 100%; aspect-ratio: 1; background: linear-gradient(135deg, #ec4899 0%, #8b5cf6 100%); display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 1.5rem; font-size: 4rem; color: white;">
                       ...
                       style="display: flex; align-items: center; padding: 1rem 1.5rem; border-bottom: 1px solid #edf2f7; text-decoration: none; color: inherit; transition: background 0.2s;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="font-size: 0.9rem; color: #718096;">
                                <i class="fa-solid fa-microphone" style="font-size: 0.75rem;"></i> {{ $song->artist->name_english }}
                                @if($song->genre)
